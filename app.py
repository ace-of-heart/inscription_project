...
KINGDOMS = [
    "Anuradhapura", "Polonnaruwa", "Dambadeniya", "Gampala", "Kotte",
    "Seethawaka", "Kandy", "Jaffna"
]

output_letters = [
    "අ", "ආ", "ඉ", "උ", "එ", "ඔ", "ක", "කි", "කු", "කෙ", "කො", "ග", "ගි", "ගු",
    "ගෙ", "ගො", "ච", "චි", "චු", "චෙ", "චො", "ඣ", "ඣි", "ඣු", "කෙධ", "කෙධා",
    "ට", "ටි", "ටු", "ටෙ", "ටො", "ඩ", "ඩි", "ඩු", "ඩෙ", "ඩො", "ණ", "ණි", "ණු",
    "ණෙ", "ණො", "ත", "ති", "තු", "තෙ", "තො", "ද", "දි", "දු", "දෙ", "දො", "න",
    "නි", "නු", "නෙ", "නො", "ප", "පි", "පු", "පෙ", "පො", "බ", "බි", "බු", "බෙ",
    "බො", "ම", "මි", "මු", "මෙ", "මො", "ය", "යි", "යු", "යෙ", "යො", "ර", "රි",
    "රු", "රෙ", "රො", "ල", "ලි", "ලු", "ලෙ", "ලො", "ව", "වි", "වු", "වෙ", "වො",
    "ශ", "ශි", "ශු", "ශෙ", "ශො", "ස", "සි", "සු", "සෙ", "සො", "හ", "හි", "හු",
    "හෙ", "හො", "ඛ", "ඝ", "ඡ", "ධ", "ඵ", "භ", "ළ", "ථ", "ඨ", "ජ"
]
...
# ====================================================================================================
      ...
      # Thresholding to get just the white parts
      _, thresh = cv2.threshold(img, 180, 255, cv2.THRESH_BINARY)
      cv2.imwrite('static/uploads/threshed_image.jpg', thresh)
      # Find the coordinates of all white pixels
      y_indices, x_indices = np.where(thresh == 255)
      # Find the white pixel coordinates
      top_left_x = min(x_indices)
      top_left_y = min(y_indices)
      bottom_right_x = max(x_indices)
      bottom_right_y = max(y_indices)
      # Crop the image
      img = thresh[top_left_y:bottom_right_y, top_left_x:bottom_right_x]

# ====================================================================================================

      # resize the image
      img = cv2.resize(img, (img_size, img_size))
      cv2.imwrite('static/uploads/modified_image.jpg', img)
